...
test("BUG-08: Stored XSS must on executed via Title and HTML Body", async ({
  page,
}) => {
  let xssExecuted = false;

  // catch alert if exist and wait till it will be closed
  ...
  await page.getByLabel("Html body").fill("<img src=x onerror=alert('xss')>");
